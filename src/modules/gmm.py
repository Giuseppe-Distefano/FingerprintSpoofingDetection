...
def gmm_kfold (D, L, K, pca_value, z_value, g0_value, g1_value):
    ...
    if pca_value==0:
        if z_value==0:
            output_file.write("No PCA, No ZNorm, G0: %d, G1: %d\n" % (g0_value, g1_value))
            print("No PCA, No ZNorm, G0: %d, G1: %d\n" % (g0_value, g1_value))
        else:
            output_file.write("No PCA, ZNorm, G0: %d, G1: %d\n" % (g0_value, g1_value))
            print("No PCA, ZNorm, G0: %d, G1: %d\n" % (g0_value, g1_value))
    else:
        if z_value==0:
            output_file.write("PCA: %d, No ZNorm, G0: %d, G1: %d\n" % (pca_value, g0_value, g1_value))
            print("PCA: %d, No ZNorm, G0: %d, G1: %d\n" % (pca_value, g0_value, g1_value))
        else:
            output_file.write("PCA: %d, ZNorm, G0: %d, G1: %d\n" % (pca_value, g0_value, g1_value))
